...
export default function ExpensesPage() {
  ...
  async function del(x: any) {
    if (!await appConfirm('Batalkan pengeluaran ini?', { title: 'Batalkan Pengeluaran', confirmText: 'Batalkan', danger: true })) return;
    try { await api(`/expenses/${x.id}`, { method: 'DELETE' }); load(); toast.success('Pengeluaran berhasil dibatalkan.'); } catch (e) { toast.error((e as Error).message); }
  }
