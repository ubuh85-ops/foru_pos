...
```bash
pnpm run recipe:import -- prisma/product-recipe-import-template.xlsx
```
...
```bash
pnpm run recipe:import -- prisma/product-recipe-import-template.xlsx --apply
```
...
docker compose -f docker-compose.prod.yml --env-file .env.production run --rm \
  ...
  api pnpm run recipe:import -- /tmp/product-recipe-import.xlsx
```
...
docker compose -f docker-compose.prod.yml --env-file .env.production run --rm \
  -v /tmp/product-recipe-import.xlsx:/tmp/product-recipe-import.xlsx \
  api pnpm run recipe:import -- /tmp/product-recipe-import.xlsx --apply
```
